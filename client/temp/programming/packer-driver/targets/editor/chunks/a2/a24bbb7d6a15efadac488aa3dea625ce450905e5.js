  ...
  return {
    ...
    execute: function () {
      ...
      _export("MentorScene", MentorScene = (_dec = ccclass('MentorScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(ScrollView), _dec10 = property(Node), _dec11 = property(Label), _dec(_class = (_class2 = class MentorScene extends Component {
        ...
        updateStudentList() {
          const content = this.studentListScrollView.content;
          ...
          for (const student of this.students) {
            ...
            const teachBtn = node.getChildByName('TeachBtn').getComponent(Button);
            teachBtn.node.on(Button.EventType.CLICK, () => this.onTeach(student), this);
        ...
        onFindMentor() {
          ...
          const selected = mentors[Math.floor(Math.random() * mentors.length)];
...
//# sourceMappingURL=a24bbb7d6a15efadac488aa3dea625ce450905e5.js.map