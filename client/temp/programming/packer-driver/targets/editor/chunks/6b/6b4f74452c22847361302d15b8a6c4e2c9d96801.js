  ...
  return {
    ...
    execute: function () {
      ...
      _export("FriendScene", FriendScene = (_dec = ccclass('FriendScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(ScrollView), _dec5 = property(Node), _dec(_class = (_class2 = class FriendScene extends Component {
        ...
        updateFriendList() {
          const content = this.friendListScrollView.content;
          ...
          for (const friend of this.friends) {
            ...
            const visitBtn = item.getChildByName('VisitBtn').getComponent(Button);
            visitBtn.node.on(Button.EventType.CLICK, () => this.onVisitFriend(friend.id), this); // 赠送按钮

            const giftBtn = item.getChildByName('GiftBtn').getComponent(Button);
            giftBtn.node.on(Button.EventType.CLICK, () => this.onGiftFriend(friend.id), this);
...
//# sourceMappingURL=6b4f74452c22847361302d15b8a6c4e2c9d96801.js.map