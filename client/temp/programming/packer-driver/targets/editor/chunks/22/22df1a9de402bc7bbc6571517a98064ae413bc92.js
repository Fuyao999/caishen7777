  ...
  return {
    ...
    execute: function () {
      ...
      _export("MailScene", MailScene = (_dec = ccclass('MailScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(ScrollView), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Button), _dec(_class = (_class2 = class MailScene extends Component {
        ...
        updateMailList() {
          const content = this.mailListScrollView.content;
          content.removeAllChildren();

          for (const mail of this.mails) {
            const item = instantiate(this.mailItemPrefab);
            ...
            btn.node.on(Button.EventType.CLICK, () => this.onMailClick(mail), this);
        ...
        onMailClick(mail) {
          ...
          for (const [key, value] of Object.entries(mail.reward)) {
        ...
        onClaimSelected() {
          ...
          for (const [key, value] of Object.entries(this.selectedMail.reward)) {
...
//# sourceMappingURL=22df1a9de402bc7bbc6571517a98064ae413bc92.js.map