  ...
  return {
    ...
    execute: function () {
      ...
      _export("QuestScene", QuestScene = (_dec = ccclass('QuestScene'), _dec2 = property(Button), _dec3 = property(Toggle), _dec4 = property(Toggle), _dec5 = property(Toggle), _dec6 = property(ScrollView), _dec7 = property(Node), _dec(_class = (_class2 = class QuestScene extends Component {
        ...
        updateQuestList() {
          const content = this.questListScrollView.content;
          ...
          for (const quest of quests) {
            ...
            const item = instantiate(this.questItemPrefab);
            ...
            const claimBtn = item.getChildByName('ClaimBtn').getComponent(Button);
            const claimLabel = claimBtn.getComponent(Label);
            ...
            if (progress.claimed) {
              ...
              claimBtn.node.on(Button.EventType.CLICK, () => this.onClaim(quest), this);
            } else {
...
//# sourceMappingURL=062658ce5c69e38f50532a6188444aa964b6c349.js.map