      ...
      _export("AuctionScene", AuctionScene = (_dec = ccclass('AuctionScene'), _dec2 = property(Button), _dec3 = property(Toggle), _dec4 = property(Toggle), _dec5 = property(Toggle), _dec6 = property(ScrollView), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Button), _dec(_class = (_class2 = class AuctionScene extends Component {
        ...
        updateItemList() {
          ...
          for (const item of this.auctionItems) {
            const node = instantiate(this.auctionItemPrefab);
            ...
            node.getChildByName('TimeLabel').getComponent(Label).string = this.formatTime(item.timeLeft); // 出价按钮

            const bidBtn = node.getChildByName('BidBtn').getComponent(Button);
            bidBtn.node.on(Button.EventType.CLICK, () => this.onBid(item), this); // 一口价按钮

            const buyoutBtn = node.getChildByName('BuyoutBtn').getComponent(Button);
            buyoutBtn.node.on(Button.EventType.CLICK, () => this.onBuyout(item), this);
        ...
        onBid(item) {
          const bidAmount = item.currentPrice + 100;
        ...
        onBuyout(item) {
          ...
          const index = this.auctionItems.indexOf(item);
...
//# sourceMappingURL=0639c77cd7a2aed50b25970dde45fb17fbe33f51.js.map