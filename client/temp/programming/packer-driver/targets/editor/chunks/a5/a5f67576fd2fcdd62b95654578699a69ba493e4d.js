    ...
    execute: function () {
      ...
      _export("BagScene", BagScene = (_dec = ccclass('BagScene'), _dec2 = property(Button), _dec3 = property(ScrollView), _dec4 = property(Node), _dec5 = property(Label), _dec(_class = (_class2 = class BagScene extends Component {
        ...
        updateBag() {
          ...
          const content = this.itemScrollView.content;
          content.removeAllChildren();
          let itemCount = 0;

          for (const item of this.items) {
            const quantity = player.getCurrency(item.id);
            ...
            if (quantity > 0 || item.type === 'equipment') {
              ...
              const useBtn = itemNode.getChildByName('UseBtn').getComponent(Button);
              useBtn.node.on(Button.EventType.CLICK, () => this.onUseItem(item.id), this);
...
//# sourceMappingURL=a5f67576fd2fcdd62b95654578699a69ba493e4d.js.map