  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapScene", MapScene = (_dec = ccclass('MapScene'), _dec2 = property(Button), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec(_class = (_class2 = class MapScene extends Component {
        ...
        initMap() {
          const domainKeys = Object.keys(this.domains);
          const positions = [new Vec3(-200, 200, 0), // 子时
          new Vec3(0, 200, 0), // 丑时
          ...
          for (let i = 0; i < domainKeys.length; i++) {
            const domainId = domainKeys[i];
            const domain = this.domains[domainId];
            const node = instantiate(this.domainNodePrefab);
            ...
            btn.node.on(Button.EventType.CLICK, () => this.onDomainClick(domainId), this);
        ...
        onDomainClick(domainId) {
          ...
          const [minLevel, maxLevel] = domain.levelRange.split('-').map(n => parseInt(n));
...
//# sourceMappingURL=9f7dd226782cad4b8b17c0713b388da6dc02712c.js.map