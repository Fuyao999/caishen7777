    ...
    execute: function () {
      ...
      _export("TempleScene", TempleScene = (_dec = ccclass('TempleScene'), _dec2 = property(Button), _dec3 = property(ScrollView), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec(_class = (_class2 = class TempleScene extends Component {
        ...
        initGodsList() {
          ...
          var content = this.godsScrollView.content;
          content.removeAllChildren();

          var _loop = function _loop(god) {
            var card = instantiate(_this.godCardPrefab);
            ...
            var worshipBtn = card.getChildByName('WorshipBtn').getComponent(Button);
            worshipBtn.node.on(Button.EventType.CLICK, () => _this.onWorshipGod(god.id), _this);
            content.addChild(card);
          };

          for (var god of this.gods) {
            _loop(god);
          }
        }
...
//# sourceMappingURL=dd411e6e02b1496b878c00bacdab1fe1fa9004ed.js.map