    ...
    execute: function () {
      ...
      _export("RankScene", RankScene = (_dec = ccclass('RankScene'), _dec2 = property(Button), _dec3 = property(Toggle), _dec4 = property(Toggle), _dec5 = property(Toggle), _dec6 = property(Toggle), _dec7 = property(ScrollView), _dec8 = property(Node), _dec9 = property(Label), _dec(_class = (_class2 = class RankScene extends Component {
        ...
        updateRankList() {
          ...
          var ranks = this.rankData[this.currentTab] || [];

          for (var item of ranks) {
            var node = instantiate(this.rankItemPrefab); // 排名图标
        ...
        updateMyRank() {
          var myLevel = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
...
//# sourceMappingURL=020eb1fdfcfdf1de9b92bb1e948439471b0e7500.js.map