System.register(["cc"], function (_export, _context) {
  ...
  // 计算玩家属性
  function calculatePlayerStats(level, equipment, stage) {
    if (equipment === void 0) {
      equipment = [];
    }
    ...
    var base = BattleBalanceConfig.playerGrowth;
    var stats = {
    ...
    var bonus = stageBonus[stage] || stageBonus.clay;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BattleBalanceConfig", BattleBalanceConfig = {
        ...
        battleFormula: {
          // 伤害计算
          damage: function damage(attackerAttack, defenderDefense, skillMultiplier, crit, critDamage) {
            if (skillMultiplier === void 0) {
              skillMultiplier = 1;
            }
            ...
            if (critDamage === void 0) {
              critDamage = 1.5;
            }

            var baseDamage = Math.max(1, attackerAttack - defenderDefense * 0.5);
            var skillDamage = baseDamage * skillMultiplier;
            var finalDamage = crit ? skillDamage * critDamage : skillDamage;
          ...
          // 暴击率
          critRate: function critRate(baseCrit) {
            if (baseCrit === void 0) {
              baseCrit = 0.05;
            }
          ...
          // 闪避率
          dodgeRate: function dodgeRate(baseDodge, levelDiff) {
            if (baseDodge === void 0) {
              baseDodge = 0.05;
            }
          ...
          elementBonus: (attackerElement, defenderElement) => {
            var elements = ['gold', 'wood', 'earth', 'water', 'fire'];
            var attackerIndex = elements.indexOf(attackerElement);
            var defenderIndex = elements.indexOf(defenderElement); // 克制链: 金克木, 木克土, 土克水, 水克火, 火克金
...
//# sourceMappingURL=3a525928d2fa8d588b0b475b21a2df6359c43990.js.map