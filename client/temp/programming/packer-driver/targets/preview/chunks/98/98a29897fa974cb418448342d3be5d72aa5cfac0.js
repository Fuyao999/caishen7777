  ...
  return {
    ...
    execute: function () {
      ...
      _export("PVPScene", PVPScene = (_dec = ccclass('PVPScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(ScrollView), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec(_class = (_class2 = class PVPScene extends Component {
        ...
        updatePlayerInfo() {
          var currentTier = this.getTierByPoints(this.playerPoints);
        ...
        updateRankList() {
          var content = this.rankListScrollView.content;
          content.removeAllChildren();

          for (var player of this.topPlayers) {
            var node = instantiate(this.rankItemPrefab);
        ...
        onMatch() {
          ...
          var matchDuration = 3 + Math.random() * 7;
          this.scheduleOnce(() => {
            this.onMatchFound();
          }, matchDuration);
        }
...
//# sourceMappingURL=98a29897fa974cb418448342d3be5d72aa5cfac0.js.map