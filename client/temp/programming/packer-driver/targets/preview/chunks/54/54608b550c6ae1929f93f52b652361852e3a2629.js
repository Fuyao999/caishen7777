  ...
  return {
    ...
    execute: function () {
      ...
      _export("SailingScene", SailingScene = (_dec = ccclass('SailingScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Sprite), _dec8 = property(Label), _dec(_class = (_class2 = class SailingScene extends Component {
        ...
        updateUI() {
          var ship = this.shipTypes[this.currentShip];
          this.shipLevelLabel.string = "\u5F53\u524D\u8239\u53EA: " + ship.name + " (Lv." + ship.level + ")";
          var mins = Math.floor(this.oxygen / 60);
          var secs = this.oxygen % 60;
        ...
        onSail() {
          // 航海探索
          var ship = this.shipTypes[this.currentShip]; // 随机事件
          ...
          for (var [key, value] of Object.entries(event.reward)) {
        ...
        onDive() {
          ...
          var diveInterval = setInterval(() => {
            ...
            if (Math.random() < 0.3) {
              foundTreasures++;
              var reward = Math.floor(Math.random() * 500) + 200;
              (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                error: Error()
...
//# sourceMappingURL=54608b550c6ae1929f93f52b652361852e3a2629.js.map