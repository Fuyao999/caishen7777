    ...
    execute: function () {
      ...
      _export("BattleScene", BattleScene = (_dec = ccclass('BattleScene'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(ProgressBar), _dec5 = property(ProgressBar), _dec6 = property(Label), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Button), _dec(_class = (_class2 = class BattleScene extends Component {
        ...
        onAttack() {
          ...
          var damage = Math.max(1, this.player.attack - this.enemy.defense + (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        onSkill() {
          ...
          this.player.mp -= 10;
          var damage = Math.max(1, Math.floor(this.player.attack * 1.5) - this.enemy.defense);
          this.enemy.hp = Math.max(0, this.enemy.hp - damage);
        ...
        enemyTurn() {
          ...
          var damage = Math.max(1, this.enemy.attack - this.player.defense + (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        onWin() {
          ...
          var rewardMoney = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
...
//# sourceMappingURL=b5e4d03b10282fb039eca251bc896b64e30686f1.js.map