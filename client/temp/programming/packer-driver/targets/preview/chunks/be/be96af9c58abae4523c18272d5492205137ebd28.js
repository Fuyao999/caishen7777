    ...
    execute: function () {
      ...
      _export("TowerScene", TowerScene = (_dec = ccclass('TowerScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(ProgressBar), _dec(_class = (_class2 = class TowerScene extends Component {
        ...
        updateUI() {
          ...
          var enemyLevel = 50 + this.currentFloor * 2;
          var enemyHp = 1000 + this.currentFloor * 500;
          var enemyAttack = 100 + this.currentFloor * 10;
          this.enemyInfoLabel.string = "\u654C\u4EBA: Lv." + enemyLevel + "\n\u8840\u91CF: " + enemyHp + "\n\u653B\u51FB: " + enemyAttack; // 难度条

          this.difficultyBar.progress = this.currentFloor / this.maxFloors; // 奖励预览

          var expReward = this.currentFloor * 1000;
          var goldReward = this.currentFloor * 500;
        ...
        onChallenge() {
          ...
          var enemyLevel = 50 + this.currentFloor * 2; // 胜负判定（简化）

          var winChance = Math.min(0.9, Math.max(0.1, (playerLevel - enemyLevel + 50) / 100));
        ...
        onSweep() {
          ...
          var expReward = Math.floor(this.currentFloor * 1000 * 0.8);
          var goldReward = Math.floor(this.currentFloor * 500 * 0.8);
          (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).getInstance().playerData.addCurrency('incense_money', goldReward);
...
//# sourceMappingURL=be96af9c58abae4523c18272d5492205137ebd28.js.map